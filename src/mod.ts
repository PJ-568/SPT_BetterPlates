...
// const SIDE_PLATE_COLLIDERS = [
//     // "LeftSideChestDown",
//     "LeftUpperArm",
//     // "RightSideChestDown",
//     "RightUpperArm"
// ]
// const LEFT_PLATE_COLLIDERS = [
//     "LeftSideChestDown",
//     "LeftUpperArm"
// ]
// const RIGHT_PLATE_COLLIDERS = [
//     "RightSideChestDown",
//     "RightUpperArm"
// ]
...
class Mod implements IPostDBLoadMod {
    public postDBLoad(container: DependencyContainer): void {
        const databaseServer = container.resolve<DatabaseServer>(DATABASE_SERVER_RESOLVER);
    ...
    private updateArmorCollidersBasedOnId(itemId, itemProps) {
        ...
        // if (SIDE_PLATE_IDS.has(itemId)) {
        //     this.updateArmorColliders(["Left_side_plate", "left_side_plate"], itemProps, LEFT_PLATE_COLLIDERS);
        // }

        // if (SIDE_PLATE_IDS.has(itemId)) {
        //     this.updateArmorColliders(["Right_side_plate", "right_side_plate"], itemProps, RIGHT_PLATE_COLLIDERS);
        // }
    }

    private updateArmorColliders(slotNames, props, colliders) {
